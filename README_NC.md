# thprac-th06nc 1.0.3：红魔乡新典非官方分支
...
本分支只提供手动更新：程序中的“下载本分支更新”打开[本仓库 Releases](https://github.com/zxxsmart/thprac-th06nc/releases/latest)。下载新 EXE，关闭游戏和启动器后替换。单文件版和多文件版均不再检查、下载或安装上游更新。项目主页、反馈入口均指向本分支，上游链接另有明确标识。当前独立版本为 1.0.3；上游版本号单独显示，保留原游戏录像版本语义。
