...
static_assert(gGameVersions[VER_TH11].gameId == ID_TH11);
static_assert(gGameVersions[VER_TH12].gameId == ID_TH12);
static_assert(gGameVersions[VER_TH123].gameId == ID_TH123);
static_assert(gGameVersions[VER_TH125].gameId == ID_TH125);
static_assert(gGameVersions[VER_TH128].gameId == ID_TH128);
static_assert(gGameVersions[VER_TH13].gameId == ID_TH13);
static_assert(gGameVersions[VER_TH135].gameId == ID_TH135);
static_assert(gGameVersions[VER_TH14].gameId == ID_TH14);
static_assert(gGameVersions[VER_TH143].gameId == ID_TH143);
static_assert(gGameVersions[VER_TH145].gameId == ID_TH145);
static_assert(gGameVersions[VER_TH15].gameId == ID_TH15);
static_assert(gGameVersions[VER_TH155].gameId == ID_TH155);
static_assert(gGameVersions[VER_TH16].gameId == ID_TH16);
...
static_assert(gGameVersions[VER_TH19_V1_10C].gameId == ID_TH19);
static_assert(gGameVersions[VER_TH19_V1_00A].initFunc == TH19_v1_00a_Init);
static_assert(gGameVersions[VER_TH19_V1_10C].initFunc == TH19_v1_10c_Init);
static_assert(gGameVersions[VER_TH20].gameId == ID_TH20);

const unsigned int gGameVersionsCount = elementsof(gGameVersions);

const THKnownGame gKnownGames[] = {
    { gGameVersions + VER_ALCOSTG,
        TYPE_ORIGINAL,
    ...
    { gGameVersions + VER_TH135,
        TYPE_SCHINESE,
        { 0xf2246b98, 0x9d4a7bf0,
            0x2c1d8f07, 0x84bc1a99 } },
    { gGameVersions + VER_TH14,
        TYPE_ORIGINAL,
    ...
    { gGameVersions + VER_TH155,
        TYPE_ORIGINAL,
        { 0xa42ea27d, 0xf14ae534,
            0xde6c96e0, 0xb78ce61b } },
    { gGameVersions + VER_TH16,
        TYPE_ORIGINAL,
